...
import { FaGithub, FaLinkedin, FaNode, FaReact, FaXTwitter } from "react-icons/fa6";
...
const HeroSection = () => {
  return (
    <div className="relative w-full lg:py-20 lg:pt-10 bg-slate-100 dark:bg-[#020617] antialiased overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl lg:px-8 ">
        <div className="flex lg:flex-row flex-col  justify-center px-4 py-10 lg:px-6">
          <div className="flex flex-col justify-center px-4 py-10 lg:z-40 ">
            <div className="mt-2 flex max-w-max items-center space-x-2 rounded-full border p-2">
              <SparklesText className="text-base mx-2 " text="Hey there!🙂" />
            </div>
            ...
            <div className="flex gap-5 mt-5 border-white border-collapse rounded">
              ...
              <a
                href="https://www.linkedin.com/in/bhavin-s307/"
                target="_blank"
              ...
              <a
                href="https://x.com/bhavin_sali307"
        ...
        <Image
            placeholder="blur"
            blurDataURL="/path/to/placeholder-image.jpg" // Add a placeholder image path
